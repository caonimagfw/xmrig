...
#   ifdef XMRIG_FEATURE_TLS
    m_pools.emplace_back(kDonateHostTls, 60000, m_userId, nullptr, nullptr, 0, true, true, mode);
#   endif
    m_pools.emplace_back(kDonateHost, 60000, m_userId, nullptr, nullptr, 0, true, false, mode);
